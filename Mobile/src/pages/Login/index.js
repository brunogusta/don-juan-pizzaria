...
const Login = (props) => {
  ...
  }, [userLogin.error || userLogin.success]);

  return (
    <ImageBackground source={BackgroundImage}>
      {useLoginForm.error && showMessage({
      ...
      <KeyboardAvoidingView behavior="padding" style={{ flex: 1 }}>
        <Container>
          ...
          >
            {({
              values, handleSubmit, handleChange, errors, isValid, setFieldTouched, touched,
            }) => (
              <Form>
                <Input
                  placeholder="E-mail"
                ...
                <BtnLogin onPress={handleSubmit} disabled={!isValid}>
                  ...
                  {useLoginForm.spin ? <Spin onSpin={useLoginForm.spin} /> : <LoginText>Entrar</LoginText>}

                </BtnLogin>

                <BtnRegister onPress={() => props.navigation.navigate('Register')}>
